    ...
    <>
      {/* <div className="navContainer"> */}
        <nav className="navContainer">
                <NavLink to="/taskslicer" className="nav-link nav-item">
                    {/* <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fad"
                ...
                <NavLink to="/" className="nav-link nav-item">
                    {/* <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 576 512"
                      className="svg-inline--fa fa-alien-monster fa-w-18 fa-9x nav-icon"
                    >
                      <g className="fa-group">
                        <path
                          fill="currentColor"
